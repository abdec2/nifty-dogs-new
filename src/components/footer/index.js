                ...
                <div className="tw-container tw-mx-auto tw-max-w-[1320px] tw-px-3">
                    <div className="tw-flex tw-items-center tw-justify-center tw-flex-col">
                        <div className="tw-max-w-[800px] tw-mb-5">
                            <h1 className="tw-text-5xl tw-font-Alfa tw-text-center">BECOME PART OF THE NIFTY DOGS COMMUNITY AND HELP PAIR VETS AND PETS!</h1>
                        </div>
                        <div className="tw-max-w-[720px] tw-mb-8">
                            <p className="tw-text-center tw-font-Barlow tw-text-lg">Join the movement to support our war veterans and learn more about the blockchain as you grow with our project.</p>
                        </div>
                        <a className="tw-font-Barlow tw-font-bold tw-uppercase tw-border tw-border-white tw-rounded-full tw-px-10 tw-py-2 hover:tw-text-gray-500 hover:tw-bg-white tw-transition-all tw-ease-in-out tw-duration-300" href="https://www.facebook.com/groups/nft101forpetlovers/?ref=share" target="_blank" rel="noreferrer">JOIN US ON FACEBOOK</a>
                    </div>
